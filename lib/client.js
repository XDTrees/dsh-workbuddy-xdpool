...
`.trim();
							...
							accountCount > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
								...
								children: [
									...
									status?.accounts.map((account) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(AccountBlock, {
										...
										onSaveCreditReserve: (accountId, reserve) => {
											saveCreditReserve(accountId, reserve);
										},
		...
		*/
		function CreditReserveRow({ account, t, busy, onSave }) {
			const [draft, setDraft] = (0, react.useState)(String(account.creditReserve ?? 0));
			(0, react.useEffect)(() => {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						...
						children: busy ? t?.("row.reserveSaving") ?? "Saving…" : t?.("row.reserveUnit") ?? "credits"
					}),
