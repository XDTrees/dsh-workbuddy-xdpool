...
`.trim();
		...
		*  date alone would read as if it lapsed at midnight. */
		...
		function AccountBlock({ account, activeAccountId, t, checkinBusyId, onClaimCheckin, accountBusyId, onToggleDisabled }) {
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
									...
									onChange: (event) => {
										onToggleDisabled(account.id, !event.target.checked);
									}
		...
		*/
		const en = {
			...
			"row.accountInRotation": "In rotation",
			"row.accountOff": "Off",
		...
		const zh = {
			...
			"row.accountNext": "下一个",
			"row.accountInRotation": "参与轮换",
			"row.accountOff": "已停用",
			"row.accountToggleHint": "把这个账号计入池子",
