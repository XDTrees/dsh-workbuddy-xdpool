...
`.trim();
		...
		*  date alone would read as if it lapsed at midnight. */
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							status?.automation === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
		...
		function AccountBlock({ account, t, checkinBusyId, onClaimCheckin, accountBusyId, onToggleDisabled }) {
		...
		*/
		const en = {
			...
			"row.autoOff": "Off",
			"row.autoBusy": "Saving…",
			"row.autoHintOn": "Reports activity, claims task rewards and checks in once a day.",
			...
			"row.autoHourNone": "not scheduled",
		...
		const zh = {
			...
			"row.autoOff": "已关闭",
			"row.autoBusy": "保存中…",
			"row.autoHintOn": "每天自动活跃上报、领取任务奖励并签到。",
